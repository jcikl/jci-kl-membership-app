...
import EfficientStarAwardComponent from '@/modules/award/components/EfficientStarAward';
import StarPointAwardComponent from '@/modules/award/components/StarPointAward';
import NationalAreaIncentiveAwardComponent from '@/modules/award/components/NationalAreaIncentiveAward';
import AwardsDashboard from '@/modules/award/components/AwardsDashboard';
import ActivityParticipationTracker from '@/modules/event/components/ActivityParticipationTracker';
import CompetitorScoreTracker from '@/modules/award/components/CompetitorScoreTracker';
import EAwardsComponent from '@/modules/award/components/EAwardsComponent';
