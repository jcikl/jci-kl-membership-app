...
import BankAccountManagement from '@/modules/finance/components/BankAccountManagement';
import TransactionManagement from '@/modules/finance/components/TransactionManagement';
import TransactionPurposeManagement from '@/modules/finance/components/TransactionPurposeManagement';
import IntegratedBudgetManagement from '@/modules/finance/components/IntegratedBudgetManagement';
import BillPaymentSystem from '@/modules/finance/components/BillPaymentSystem';
import FinancialReports from '@/modules/finance/components/FinancialReports';
import FinancialReportGenerator from '@/modules/finance/components/FinancialReportGenerator';
import ExpenseSplittingModal from '@/modules/finance/components/ExpenseSplittingModal';
import MembershipFeeManagement from '@/modules/member/components/MembershipFeeManagement';
...
import { financialReportService as newFinancialReportService } from '@/modules/finance/services/financialReportService';
import {
  BankAccount,
  Transaction,
  TransactionPurpose,
...
const FinancePageContent: React.FC = () => {
  ...
  // 使用全局年份和月份状态
  const { selectedYear, setSelectedYear, selectedMonth, setSelectedMonth, availableYears, refreshAvailableYears } = useFinanceYear();
    ...
    <Layout>
      <Content style={{ padding: '24px' }}>
        <div style={{ marginBottom: 24 }}>
          ...
          <Text type='secondary'>
            JCI Kuala Lumpur 标准财务管理系统 - {selectedYear}年{selectedMonth ? `${selectedMonth}月` : '全年'}
          </Text>
        </div>
