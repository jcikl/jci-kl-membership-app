...
import { getHeadquartersSettings, saveHeadquartersSettings, getDefaultHeadquartersSettings } from '@/modules/system/services/headquartersSettingsService';
import { 
  getWorldRegions, 
  createWorldRegion, 
  updateWorldRegion, 
...
import type { HeadquartersSettings as HeadquartersSettingsType, WorldRegion, Country } from '@/types';
...
const HeadquartersSettings: React.FC = () => {
  ...
  const [settings, setSettings] = useState<HeadquartersSettingsType | null>(null);
  ...
  const hasChanges = () => {
    ...
    return Object.keys(currentValues).some(key => {
      ...
      const originalValue = settings[key as keyof HeadquartersSettingsType];
